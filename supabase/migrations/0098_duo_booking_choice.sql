-- ════════════════════════════════════════════════════════════════
-- 0098 · Sessão duo passa a ser uma ESCOLHA (não forçada)
--
-- Substitui create_booking / create_booking_admin (definidos em 0096):
-- uma sessão só conta para as duas contas quando o cliente marca COM
-- créditos DUPLOS (session_type = 'dupla') E tem um par activo. Marcar
-- uma sessão individual — mesmo estando ligado — desconta só a ele.
--
-- Append-only: 0096 fica como foi aplicado; este ficheiro redefine
-- apenas as duas funções (create or replace) com a nova lógica.
-- ════════════════════════════════════════════════════════════════
