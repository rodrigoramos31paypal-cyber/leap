...
export function revalidateCreditsViews(clientId?: string) {
  ...
  revalidateTag("client-credits", "max");
  if (clientId) revalidateTag(`client-credits:${clientId}`, "max");
...
export function revalidateBookingViews(clientId?: string) {
  ...
  if (clientId) revalidateTag(`bookings:${clientId}`, "max");
...
export function revalidateProfileViews(profileId?: string) {
  ...
  if (profileId) revalidateTag(`profile:${profileId}`, "max");
...
export function revalidateTeamViews() {
  ...
  revalidateTag("active-trainers", "max");
